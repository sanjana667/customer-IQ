    ...
    <aside className="w-64 h-screen bg-slate-900 border-r border-slate-800 flex flex-col fixed left-0 top-0">
      ...
      <div className="px-6 py-5 border-b border-slate-800">
        ...
        {session?.user?.workspaceName && (
          <div className="mt-2 text-xs text-slate-500 truncate">{session.user.workspaceName}</div>
        )}
      </div>
      ...
      <div className="p-4 border-t border-slate-800">
        ...
        <button
          ...
          className="w-full text-left text-sm text-slate-400 hover:text-white px-2 py-1.5 rounded hover:bg-slate-800 transition flex items-center gap-2"
        >
